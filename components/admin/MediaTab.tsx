...
export default function MediaTab() {
  ...
  const [groupLabel, setGroupLabel] = useState("언론 보도");
  ...
  async function remove(id: string) {
    await supabase.from("media_links").delete().eq("id", id);
    reload();
  }
  ...
  return (
    <div>
      <h1 className="mb-5 text-[22px] font-extrabold tracking-tight">MEDIA 관리</h1>
