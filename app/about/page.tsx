...
export const metadata: Metadata = {
  ...
  description:
    "뷰티 채용·취업 플랫폼 앤마들린 채용에서 글로브 채용, 플릭스 채용 정보를 확인하세요. 뷰티 릴스 제작 플랫폼 글로브(Glovv)와 AI 뷰티 애니메이션 플릭스(Flixx)를 운영하는 앤마들린 주식회사를 소개합니다.",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden border-b border-gray-200 bg-gradient-to-b from-white to-gray-50">
        ...
        <div className="relative mx-auto max-w-[1120px] px-5 pb-16 pt-[72px]">
          ...
          <h1 className="mb-4 mt-3.5 max-w-[720px] break-keep text-[32px] font-extrabold leading-[1.18] tracking-tight sm:text-[44px]">
            대부분의 뷰티 브랜드가{" "}
